          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="<?php echo base_url(); ?>category/index">
                <i class="fa fa-dashboard"></i> <span>Category Information</span> 
                <!-- <i class="fa fa-angle-left pull-right"></i> -->
              </a>
            ...
            <li class="treeview">
              <a href="<?php echo base_url(); ?>question/request">
                <i class="fa fa-dashboard"></i> <span>User Question Request</span> 
                <!-- <i class="fa fa-angle-left pull-right"></i> -->
              </a>
